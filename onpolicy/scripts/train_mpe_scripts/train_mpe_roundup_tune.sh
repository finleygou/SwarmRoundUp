...
num_landmarks=0
num_good_agents=0
num_adversaries=0 # policy agents
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES='2,4' python ../train/train_mpe.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} \
    ...
    --model_dir "/home/sdc/goufandi_space/Projects/SwarmRoundUp_V2/onpolicy/scripts/results/MPE/simple_round_up2/rmappo/check/wandb/run-20231103_211604-14n3mc4j/files/"\
    --ppo_epoch 15 --gain 0.01 --lr 1.5e-4 --critic_lr 1.5e-4 --wandb_name "xxx" --user_name "finleygou"
done
# tune 37 base: run-20231026_222247-3kflqiwv
# tune 38 base: run-20231029_112243-1x3u5pkr
# tune 39 base: run-20231101_212754-rx2melpl
# tune 40 base: run-20231103_211604-14n3mc4j