...
def get_config():
    ...
    parser.add_argument("--decay_ratio",  type=float, default=0.0, help="the final ratio of init_lr when using decay.")
    ...
    parser.add_argument("--save_data", action='store_true', default=True, help='use to save data in rendering or training')
