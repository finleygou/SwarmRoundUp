...
class Scenario(BaseScenario):
    def make_world(self, args):
        ...
        world.collaborative = True  # share reward
        # add agents
    ...
    def reward(self, agent, world):
        ...
        a = world.agents[0]
        dist2 = np.sum(np.square(a.goal_a.state.p_pos - a.goal_b.state.p_pos))  # 距离平方
        return -dist2
    ...
    def observation(self, agent, world):
        ...
        for other in world.agents:
            if other is agent or (other.state.c is None):  # 自己or不具备通信能力的agent
                continue
